...
const svgPath = path.join(publicDir, 'bittee-logo2.svg');

// Sizes needed for iOS and Android
const iconSizes = [
  { size: 60, name: 'bittee-logo2-60.png' },   // iOS iPhone
  { size: 76, name: 'bittee-logo2-76.png' },   // iOS iPad
  { size: 120, name: 'bittee-logo2-120.png' }, // iOS iPhone
  { size: 152, name: 'bittee-logo2-152.png' }, // iOS iPad
  { size: 180, name: 'bittee-logo2-180.png' }, // iOS iPhone (required)
  { size: 192, name: 'bittee-logo2-192.png' }, // Android
  { size: 512, name: 'bittee-logo2-512.png' }, // Android (required)
];
